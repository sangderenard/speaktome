...
import numpy as np
from .mitsubashell import MitsubaShell
...
class ThreadManager:
    ...
    def __init__(self):
        ...
        self.mitsuba_shell = MitsubaShell(self)
        logging.info("ThreadManager initialized with MitsubaShell.")
    ...
    def stop_all(self):
        # Stop all managed threads and resources
        self.mitsuba_shell.stop()
        # ... stop other threads if necessary ...
        logging.info("ThreadManager stopped all threads.")