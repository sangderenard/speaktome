...
class BuildLaplace3D:
    ...
    def build_general_laplace(self, grid_u, grid_v, grid_w, boundary_conditions=None, singularity_conditions=None, 
        ...
        diagonal_entries = torch.zeros(total_size, device='cuda')
        ...
        flat_diag_indices = torch.arange(total_size, device='cuda')
        ...
        laplacian = torch.sparse_coo_tensor(
            indices=torch.tensor([row_indices, col_indices], device='cuda'),
