...
public class SegmentLapMesg extends Mesg implements MesgWithEvent   {
    ...
    static {
        ...
        segmentLapMesg.fields.get(field_index).components.add(new FieldComponent(91, false, 16, 5, 500)); // enhanced_avg_altitude
        field_index++;
        segmentLapMesg.addField(new Field("max_altitude", MaxAltitudeFieldNum, 132, 5, 500, "m", false, Profile.Type.UINT16));
        segmentLapMesg.fields.get(field_index).components.add(new FieldComponent(92, false, 16, 5, 500)); // enhanced_max_altitude
        field_index++;
        ...
        segmentLapMesg.fields.get(field_index).components.add(new FieldComponent(93, false, 16, 5, 500)); // enhanced_min_altitude
        field_index++;
        ...
        field_index++;
        segmentLapMesg.addField(new Field("enhanced_avg_altitude", EnhancedAvgAltitudeFieldNum, 134, 5, 500, "m", false, Profile.Type.UINT32));
        field_index++;
        segmentLapMesg.addField(new Field("enhanced_max_altitude", EnhancedMaxAltitudeFieldNum, 134, 5, 500, "m", false, Profile.Type.UINT32));
        field_index++;
        segmentLapMesg.addField(new Field("enhanced_min_altitude", EnhancedMinAltitudeFieldNum, 134, 5, 500, "m", false, Profile.Type.UINT32));
        field_index++;
    }
