...
public class LapMesg extends Mesg implements MesgWithEvent   {
    ...
    static {
        ...
        field_index++;
        lapMesg.addField(new Field("avg_depth", AvgDepthFieldNum, 134, 1000, 0, "m", false, Profile.Type.UINT32));
        field_index++;
        lapMesg.addField(new Field("max_depth", MaxDepthFieldNum, 134, 1000, 0, "m", false, Profile.Type.UINT32));
        field_index++;
        lapMesg.addField(new Field("min_temperature", MinTemperatureFieldNum, 1, 1, 0, "C", false, Profile.Type.SINT8));
        field_index++;
        lapMesg.addField(new Field("enhanced_avg_respiration_rate", EnhancedAvgRespirationRateFieldNum, 132, 100, 0, "Breaths/min", false, Profile.Type.UINT16));
        field_index++;
        lapMesg.addField(new Field("enhanced_max_respiration_rate", EnhancedMaxRespirationRateFieldNum, 132, 100, 0, "Breaths/min", false, Profile.Type.UINT16));
        field_index++;
        lapMesg.addField(new Field("avg_respiration_rate", AvgRespirationRateFieldNum, 2, 1, 0, "", false, Profile.Type.UINT8));
        lapMesg.fields.get(field_index).components.add(new FieldComponent(136, false, 8, 1, 0)); // enhanced_avg_respiration_rate
        field_index++;
        lapMesg.addField(new Field("max_respiration_rate", MaxRespirationRateFieldNum, 2, 1, 0, "", false, Profile.Type.UINT8));
        lapMesg.fields.get(field_index).components.add(new FieldComponent(137, false, 8, 1, 0)); // enhanced_max_respiration_rate
        field_index++;
